...
class catanGame():
    ...
    def __init__(self):
        ...
        #Initialize and display initial board
        ...
        self.endTurn_button = pygame.Rect(20, 170, 80, 40)
        ...
        self.board.screen.blit(endTurnText, (30,180))
                        ...
                        if(e.type == pygame.MOUSEBUTTONDOWN):
                            if(self.buildRoad_button.collidepoint(e.pos)):
                                ...
                                if(diceRolled == True): #Can only build after rolling dice
                                        self.board.get_potential_roads(currPlayer)
